...
CLASS mainapp IMPLEMENTATION.
  METHOD main.
    ...
    c1->declear( 'We are not allowed to develop nuclear weapons, otherwise we will start a war' ).
    c2->declear( 'We have no nuclear weapons and we are not afraid of aggression' ).
  ENDMETHOD.
ENDCLASS.
